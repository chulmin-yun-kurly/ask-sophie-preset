...
import sys
import pandas as pd
from config import MODEL_MAIN, PREPARE_BATCH_SIZE, PREPARE_MAX_CONCURRENT, TEMP_PRODUCT_ANSWER
...
"""
    ...
    parsed = await chat_json(MODEL_MAIN, system_prompt, user_prompt, temperature=TEMP_PRODUCT_ANSWER)
