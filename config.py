...
# 클러스터링 dedup 임계값
CLUSTER_PRE_DEDUP_THRESHOLD = 0.93    # Step A: semantic pre-dedup (높은 기준 = 거의 동일)
CLUSTER_POST_DEDUP_THRESHOLD = 0.85   # Step B/C: post-merge dedup (중간 기준)
CLUSTER_CROSS_MAX_CONCURRENT = 5      # Step C: LLM 확인 동시 요청 수
CLUSTER_COHESION_THRESHOLD = 0.70     # Step E: 그룹 내 평균 pairwise cosine 최소값 (미만 제거)
